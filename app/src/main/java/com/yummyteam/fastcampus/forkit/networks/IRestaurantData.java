...
public interface IRestaurantData {
    ...
    @FormUrlEncoded
    @PATCH("/api/v1/restaurants/{r_id}/reviews/{id}/")
    Call<Reviews> modifiReview(@Header("Authorization")String Authorization,@Path("r_id")String r_id,@Path("id")String id,@FieldMap Map<String,String> keys);
}
